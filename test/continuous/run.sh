...
# Removing until a3-mega is released
# . ./test/continuous/a3-mega/terraform/modules/cluster/mig/tests.sh
# . ./test/continuous/a3-mega/terraform/modules/cluster/mig-cos/tests.sh
# . ./test/continuous/a3-mega/terraform/modules/cluster/gke/tests.sh
# . ./test/continuous/a3-mega/terraform/modules/cluster/gke-beta/tests.sh
