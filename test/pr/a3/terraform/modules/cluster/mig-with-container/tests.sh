...
mig-with-container::src_dir () {
    echo "${PWD}/a3/terraform/modules/cluster/mig-with-container"
}

mig-with-container::input_dir () {
    echo "${PWD}/test/pr/a3/terraform/modules/cluster/mig-with-container/input"
}

mig-with-container::output_dir () {
    echo "${PWD}/test/pr/a3/terraform/modules/cluster/mig-with-container/output"
}
