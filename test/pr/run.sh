...
. ./test/pr/a3-mega/terraform/modules/cluster/mig/tests.sh
. ./test/pr/a3-mega/terraform/modules/cluster/mig-cos/tests.sh
. ./test/pr/a3-mega/terraform/modules/cluster/gke/tests.sh
. ./test/pr/a3-mega/terraform/modules/common/dashboard/tests.sh
. ./test/pr/a3-mega/terraform/modules/common/instance_template/tests.sh
. ./test/pr/a3-mega/terraform/modules/common/instance_group_manager/tests.sh
. ./test/pr/a3-mega/terraform/modules/common/network/tests.sh
. ./test/pr/a3-mega/terraform/modules/common/resource_policy/tests.sh
