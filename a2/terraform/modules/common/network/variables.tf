...
variable "nic_existing" {
  description = "Existing network to attach to the host nic. Setting to null will create a new network for it."
  type = object({
    network_name    = string
...
variable "region" {
  description = <<-EOT
    The region in which the subnetwork has been / will be created.
