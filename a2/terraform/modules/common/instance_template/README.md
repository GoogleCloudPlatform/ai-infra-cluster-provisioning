...
| <a name="input_network_self_link"></a> [network\_self\_link](#input\_network\_self\_link) | The network self-link for the host VPC. | `list(string)` | n/a | yes |
...
| <a name="input_subnetwork_self_link"></a> [subnetwork\_self\_link](#input\_subnetwork\_self\_link) | The subnet self-link for the host VPC. | `string` | n/a | yes |
