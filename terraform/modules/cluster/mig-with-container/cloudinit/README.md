...
|------|-------------|------|---------|:--------:|
| <a name="input_container"></a> [container](#input\_container) | n/a | <pre>object({<br>    image                = string<br>    cmd                  = string<br>    env                  = map(string)<br>    options              = list(string)<br>    enable_cloud_logging = bool<br>  })</pre> | n/a | yes |
