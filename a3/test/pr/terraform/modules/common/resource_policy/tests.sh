...
resource_policy::src_dir () {
    echo "${PWD}/terraform/modules/common/resource_policy"
}

resource_policy::input_dir () {
    echo "${PWD}/test/pr/terraform/modules/common/resource_policy/input"
}

resource_policy::output_dir () {
    echo "${PWD}/test/pr/terraform/modules/common/resource_policy/output"
}
